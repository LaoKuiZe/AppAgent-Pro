...
def word_iterator(text: str, time_per_word: float = 0.05):
    """
    A generator that yields each word in the text with a delay between each word.
    :param text: The text to iterate over.
    :param time_per_word: The delay in seconds between each word.
    """
    words = text.split(" ")
    for word in words:
        yield word + " "
